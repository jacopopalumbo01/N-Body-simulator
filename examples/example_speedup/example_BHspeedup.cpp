...
int main(int argc, char *argv[])
{
    ...
    NBodyEnv::System<NBodyEnv::VerletDiscretizer> renderSystem(NBodyEnv::Functions::getGravFunc(), NBodyEnv::VerletDiscretizer(), 60);
    NBodyEnv::System<NBodyEnv::VerletDiscretizer> system(NBodyEnv::Functions::getGravFunc(), NBodyEnv::VerletDiscretizer(), 60);
    NBodyEnv::System<NBodyEnv::VerletDiscretizer> systemBH(NBodyEnv::Functions::getGravFunc(), NBodyEnv::VerletDiscretizer(), 60);
    ...
    // constexpr int timesteps = 3600 * 24 * 7;
    constexpr int timesteps = 360;
    // constexpr int timesteps = 360;

    // Create exporter
    NBodyEnv::Exporter exporter("test.part", 60);
